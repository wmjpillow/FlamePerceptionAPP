...
img = cv2.imread('/Users/wangmeijie/ALLImportantProjects/FlameDetectionAPP/MaskRCNN/JPEGImages/frame1808.jpg')
gs = cv2.cvtColor(img,cv2.COLOR_BGR2GRAY)


gs_neg = 255 - gs.astype(int)
# gs_neg[gs_neg>800] = 1000  02/26/2020
gs_neg[gs_neg>800] = 1000
